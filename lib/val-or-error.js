/** @template V @typedef { import('./val-or-error.ts').Val<V>      } Val */
/** @typedef             { import('./val-or-error.ts').Err         } Err */
/** @template V @typedef { import('./val-or-error.ts').ValOrErr<V> } ValOrErr */
